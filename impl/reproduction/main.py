...
#from losses import *
from policies import build_image_discrete_policy, build_discrete_Q_model, build_image_continuous_Q_function, build_image_autoregressive_policy
from samplers import create_grasping_env_discrete_sampler, create_grasping_env_soft_q_sampler
from replay_buffer import ReplayBuffer
from train_functions import train_discrete_sigmoid, create_train_discrete_Q_sigmoid, validation_discrete_sigmoid
...
def discrete_soft_q_grasping(args):
    ...
    validation_buffer = ReplayBuffer(size=num_samples_total, observation_shape=(image_size, image_size, 3), action_dim=1, raw_action_dim=(2,))   
    # run the training
    ...
    all_diagnostics, train_buffer, _ = training_loop(
        ...
        train_function = train_function, validation_function = validation_discrete_sigmoid,
        savedir=savedir,
