    ...
    while num_samples < num_samples_total:
        ...
        if eval_sampler is not None:
            ...
            for i in range(num_eval_samples_per_epoch):
                ...
                for k in infos: sampler_infos[k].append(infos[k])
        ...
        if eval_env:
            ...
            for i in range(num_eval_samples_per_epoch):
                ...
                for k in infos: eval_infos[k].append(infos[k])
                eval_successes += reward
                if validation_buffer: validation_buffer.store_sample(obs, action, reward)
